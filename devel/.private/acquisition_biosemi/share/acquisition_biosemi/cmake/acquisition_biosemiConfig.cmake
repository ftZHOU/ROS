...
if("TRUE" STREQUAL "TRUE")
  set(acquisition_biosemi_SOURCE_PREFIX /usr/users/promo2018/zhou_fen/catkin_ws/src/acquisition_biosemi)
  set(acquisition_biosemi_DEVEL_PREFIX /usr/users/promo2018/zhou_fen/catkin_ws/devel/.private/acquisition_biosemi)
  ...
  set(acquisition_biosemi_INSTALL_PREFIX /usr/users/promo2018/zhou_fen/catkin_ws/install)
...
if(NOT "/usr/users/promo2018/zhou_fen/catkin_ws/devel/.private/acquisition_biosemi/include " STREQUAL " ")
  set(acquisition_biosemi_INCLUDE_DIRS "")
  set(_include_dirs "/usr/users/promo2018/zhou_fen/catkin_ws/devel/.private/acquisition_biosemi/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'acquisition_biosemi' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'gutzwiller <gutzwiller@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'acquisition_biosemi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/users/promo2018/zhou_fen/catkin_ws/src/acquisition_biosemi/${idir}'.  Ask the maintainer 'gutzwiller <gutzwiller@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/users/promo2018/zhou_fen/catkin_ws/devel/.private/acquisition_biosemi/lib;/usr/users/promo2018/zhou_fen/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
