...
set(MSG_I_FLAGS "-Iacquisition_biosemi:/usr/users/promo2018/zhou_fen/catkin_ws/src/acquisition_biosemi/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/usr/users/promo2018/zhou_fen/catkin_ws/src/acquisition_biosemi/msg/biosemi_result.msg" NAME_WE)
add_custom_target(_acquisition_biosemi_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "acquisition_biosemi" "/usr/users/promo2018/zhou_fen/catkin_ws/src/acquisition_biosemi/msg/biosemi_result.msg" ""
)

get_filename_component(_filename "/usr/users/promo2018/zhou_fen/catkin_ws/src/acquisition_biosemi/msg/biosemi_echantillon.msg" NAME_WE)
add_custom_target(_acquisition_biosemi_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "acquisition_biosemi" "/usr/users/promo2018/zhou_fen/catkin_ws/src/acquisition_biosemi/msg/biosemi_echantillon.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/acquisition_biosemi)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/acquisition_biosemi\")")
  # install generated code
  install(
