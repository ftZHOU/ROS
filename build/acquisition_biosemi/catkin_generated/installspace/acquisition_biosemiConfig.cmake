...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'acquisition_biosemi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/users/promo2018/zhou_fen/catkin_ws/install/${idir}'.  Ask the maintainer 'gutzwiller <gutzwiller@todo.todo>' to fix it.")
    endif()
